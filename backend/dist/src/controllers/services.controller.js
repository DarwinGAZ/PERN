...
import { createServiceService, deleteServicesService, getAllServicesService, getLocationsOnServicesService, getMyServicesService, getServiceByIdService, updateServiceService, } from "../services/serviceService.js";
export const createService = async (req, res) => {
    ...
    const newService = await createServiceService(title, description, price, location, ownerId);
...
export const deleteService = async (req, res) => {
    ...
    const deletedService = await deleteServicesService(serviceId);
    if (!deletedService) {
...
export const getLocationsOnServices = async (req, res) => {
